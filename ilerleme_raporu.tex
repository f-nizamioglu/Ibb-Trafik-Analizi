...
% [Şekil: threshold\_impact.png — hız ve araç eşiklerinin küme sayısına etkisi]
% [Şekil: eps\_minpoints\_impact.png — eps ve minpoints kombinasyonlarının karşılaştırması]
% [Şekil: runtime\_comparison.png — konfigürasyona göre çalışma süresi dağılımı]
