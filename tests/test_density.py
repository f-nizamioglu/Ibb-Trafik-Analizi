"""
Tests for shared geohash density helper logic.
...
def test_decode_geohash_bounds_known_cell():
    ...
    min_lat, min_lon, max_lat, max_lon = decode_geohash_bounds("u09tun")
...
def test_decode_geohash_istanbul():
    ...
    from scoring.geohash_utils import decode_geohash_bounds
    # sxk9jc is a 6-char Bostancı-area cell from the IBB dataset.
...
def test_density_candidates_basic():
    ...
    from scoring.geohash_utils import compute_density_candidates
